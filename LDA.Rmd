...
lm <- lm(cortisol ~ time + starting_cortisol, data=exploration_cortisol)
exploration_cortisol$time <- as.factor(exploration_cortisol$time)
summary(lm)

mod1 <- afex::mixed(cortisol ~ time * distraction_coping + (1|ID), set_data_arg = TRUE, data=exploration_cortisol)
summary(mod1)
```
